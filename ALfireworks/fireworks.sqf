// by Hectrim
// nul = [obj_pozition,duration] execvm "ALfireworks\rock.sqf";
...
// genereaza rachete cu sunet
	_rocket_handler = [_obj,_h,_firflut] execVM "ALfireworks\rock.sqf"; 
	waitUntil {scriptDone _rocket_handler};

// genereaza lumina
	nul = [_obj,_ro,_ve,_bl,_h] execvm "ALfireworks\lumina.sqf";

// genereaza scantei
	_sparks_handler = [_lansspark,_ro,_ve,_bl,_h] execvm "ALfireworks\sparks.sqf";
